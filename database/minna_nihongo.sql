...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2018 at 10:36 AM
...
--
-- Table structure for table `tbl_basic_draw_line`
--

CREATE TABLE `tbl_basic_draw_line` (
  `id` int(11) NOT NULL,
  `original` varchar(50) NOT NULL,
  `meaning_china` varchar(50) NOT NULL,
  `meaning_vn` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_bunkei`
--

CREATE TABLE `tbl_bunkei` (
  `id` int(5) NOT NULL,
...
--
-- Table structure for table `tbl_conversation_type`
--

CREATE TABLE `tbl_conversation_type` (
  `id` int(5) NOT NULL,
...
--
-- Table structure for table `tbl_reibun`
--

CREATE TABLE `tbl_reibun` (
  `id` int(5) NOT NULL,
  `lesson_id` int(5) NOT NULL,
  `content` varchar(2500) NOT NULL,
  `sort_no` int(5) NOT NULL,
...
--
-- Indexes for table `tbl_basic_draw_line`
--
ALTER TABLE `tbl_basic_draw_line`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_bunkei`
--
ALTER TABLE `tbl_bunkei`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_conversation_type`
--
ALTER TABLE `tbl_conversation_type`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_reibun`
--
ALTER TABLE `tbl_reibun`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_basic_draw_line`
--
ALTER TABLE `tbl_basic_draw_line`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_bunkei`
--
ALTER TABLE `tbl_bunkei`
...
ALTER TABLE `tbl_conversation`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_conversation_type`
--
ALTER TABLE `tbl_conversation_type`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `tbl_refer`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_reibun`
--
ALTER TABLE `tbl_reibun`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;
--
