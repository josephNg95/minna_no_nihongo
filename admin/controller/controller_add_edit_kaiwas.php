<?php 
    ...
    switch ($act) {
        case 'edit':
            $kaiwa = fetch_one("select * from tbl_kaiwa where lesson_id=$lessId");
            ...
            execute("update tbl_kaiwa set title='$titleKana',romaji_title='$titleRomaji',vietnam_title = '$titleVn', flag='$status' where id = $kid");
        ...
        case 'add':
            ...
            execute("insert into tbl_kaiwa(lesson_id,title,romaji_title,vietnam_title,flag)
        ...
        case 'addcon':
            ...
            execute("insert into tbl_kaiwa_content(name_jp, name_rm, content_jp, content_rm, content_vn, kaiwa_id, flag) 
        ...
        case 'editcon':
            ...
            execute("update tbl_kaiwa_content set name_jp='$name_jp', name_rm='$name_rm', content_jp='$content_jp', content_rm='$content_rm', content_vn='$content_vn', flag='$flag' where id=$kaiwaId");
