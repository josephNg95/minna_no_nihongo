    ...
    <div class="col-md-12">
        ...
        <table cellpadding="5" class="table table-bordered table-hover">
            <tr style="background-color: #ddd;">
                ...
                <!-- <th style="width: 100px; ">Bunkei</th>
                <th style="width: 100px; ">Reibun</th>
                <th style="width: 150px; ">Tham khảo</th> -->
            ...
            <tr style="text-align: center; ">
                ...
                <!-- <td>
                    <a href="index.php?controller=bunkeis&id=<?= $lesson['id'];?>">Bunkei</a>
                </td>
                <td>
                    <a href="index.php?controller=reibuns&id=<?= $lesson['id'];?>">Reibun</a>
                </td>
                <td>
                    <a href="index.php?controller=references&id=<?= $lesson['id'];?>">Tham khảo</a>
                </td> -->
                <td>
