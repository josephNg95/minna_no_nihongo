            ...
            <div class="modal-content" style="border-radius:3px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control input-sm" name="kanji" id="kanji" maxlength="30" placeholder="学生">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="mean_ch" class="col-sm-3 control-label">Nghĩa Hán-Việt</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control input-sm" name="mean_ch" id="mean_ch" placeholder="học sinh" maxlength="30">
                        </div>
                    </div>
