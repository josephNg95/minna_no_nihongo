            ...
            <div class="modal-content" style="border-radius:3px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="original" id="original" maxlength="1" placeholder="Nhập chữ của bạn" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="romaji" class="col-sm-3 control-label">Romaji</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="romaji" id="romaji" maxlength="1" placeholder="Nhập romaji" required>
                        </div>
                    </div>
                </div>
