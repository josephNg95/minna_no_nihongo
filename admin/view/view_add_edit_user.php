    ...
    <div class="row">
        <div class="col-md-8">
            <form method="post" action="<?php echo $form_control;?>" enctype="multipart/form-data">
                ...
                <div>
                    <i><p class="text-muted">Mật khẩu ban đầu sẽ là: <span style="color: red">123456</span></p></i>
                </div>
                <!-- row -->
                <div class="row" style="margin-top: 15px; ">
                    <div class="col-md-9">
                        <button type="submit" class="btn btn-primary">
                            <i class="glyphicon glyphicon-ok"> Lưu</i>
                        </button>
                        <button type="reset" class="btn btn-warning">
                            <span class="glyphicon glyphicon-refresh" style="word-spacing: -8px;"> Nhập lại</span>
                        </button>
                    </div>
                </div>
                <!-- end row -->
