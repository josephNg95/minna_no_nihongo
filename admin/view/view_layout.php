  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
          ...
          <li class="<?php echo isset($_GET["controller"])&&$_GET["controller"]=="user"?"active":"";?>"><a href="index.php?controller=user">Mẫu câu giao tiếp</a></li>
          <li class="<?php echo isset($_GET["controller"])&&$_GET["controller"]=="user"?"active":"";?>"><a href="index.php?controller=user">Luyện thi</a></li>
          <li class="<?php echo isset($_GET["controller"])&&$_GET["controller"]=="user"?"active":"";?>"><a href="index.php?controller=user">Bài viết</a></li>
