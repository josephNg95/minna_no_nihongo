  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
          ...
          <li class="<?php echo isset($_GET["controller"])&&($_GET["controller"]=="post"||$_GET["controller"]=="add_edit_post")?"active":"";?>"><a href="index.php?controller=post">Các bài viết</a></li>
          <li class="<?php echo isset($_GET["controller"])&&($_GET["controller"]=="contact"||$_GET["controller"]=="contact")?"active":"";?>"><a href="index.php?controller=contact">Liên hệ</a></li>
          <li class="<?php echo isset($_GET["controller"])&&$_GET["controller"]=="user"?"active":"";?>">
              <a href="<?php echo ($_SESSION['level'] == 0) ? 'index.php?controller=user':'';?>">
                <?php echo ($_SESSION['level'] == 0) ? 'Người dùng':'';?>
              </a>
          </li>
        </ul>
    </div>
