            ...
            <div class="modal-content" style="border-radius:3px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control input-sm" name="ed_kanji" id="ed_kanji" maxlength="30" placeholder="学生" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ed_mean_ch" class="col-sm-3 control-label">Nghĩa Hán-Việt</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control input-sm" name="ed_mean_ch" id="ed_mean_ch" placeholder="học sinh" maxlength="30" required>
                        </div>
                    </div>
