            ...
            <div class="modal-content" style="border-radius:3px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="edit_original" id="edit_original" maxlength="5" placeholder="Nhập chữ của bạn" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="romaji" class="col-sm-3 control-label">Romaji</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="edit_romaji" id="edit_romaji" maxlength="10" placeholder="Nhập romaji" required>
                        </div>
                    </div>
